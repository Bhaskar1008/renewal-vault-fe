...
export default {
    ...
    created(){
        ...
        this.GET('/fetch_document_type?filter=30',res => {
    ...
    methods:{
        ...
        resetFunct(){
            ...
            this.POST('gen_random_key',formData,res=>{
                    if(res.data.errCode  == -1){
        ...
        Searchdatatable (e) {
            ...
            if(this.channelFilter == 'all'){
                FilterData = 'getallAgent?user_id='+this.$store.state.agentDetails._id+'&skip=0&searchtxt='+this.value+'&searchType=fname'
                console.log("Search Filter all")
            }else{
                FilterData ='getallAgent?user_id='+this.$store.state.agentDetails._id+'&channelCode='+this.channelFilter+'&skip=0&searchtxt='+this.value+'&searchType=fname'
        ...
        GetUserData(e){
            ...
            this.GETUSER('getmyAttendance/'+user+'?sortBy=604800000&skip='+this.Userskip,res => {
        ...
        getrole(chanel, cb = null){
            this.GET('getrole?userId='+this.$store.state.agentDetails._id+'&channelCode='+chanel,res => {
        ...
        getuserdatareporting(e,skip){
            ...
            this.GET('users_count/'+this.$store.state.agentDetails._id, res => {
        ...
        goUserNxt(){
            ...
            this.POST('agent_bulk_upload/'+this.getAgentInfo()._id,formData,res=>{
                if(res.data.errCode==-1){
        ...
        branchlist(chn, cb = null) {
            this.GET('getbranch?created_by='+this.$store.state.agentDetails._id+'&branchfilter=All&channelCode=' + chn,res => {
                    this.branchArray = [];
        ...
        Getdesignation(chn, cb = null){
            this.GET('getDesignationMaster?userId='+this.$store.state.agentDetails._id+'&channelCode='+chn,res => {
        ...
        heirarchydatalist(chn, cb = null) {
            ...
            this.GET('getHierarchy?userId=' + this.user_id + '&channelCode=' + chn,res => {
                    if(res.data.errMsg[0].length == 0){
        ...
        else
        {
            ...
            this.POST('v3/addagent/',senduserData,res => {
