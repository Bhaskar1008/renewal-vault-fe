    ...
    <v-app>
        <!-- <v-content> -->
            <v-container grid-list-md text-xs-center fluid>
                <h2 color="grey" style="display:flex;color:grey;">B Dashboard</h2>
                <v-divider></v-divider>
...
import UserManagement from '../../component/usercomponentNEW.vue';
// Map Chart
        ...
        getuserscount(){
            console.log("DID we Emit event?");
                if(this.emiton){
                    ...
                    this.GET('users_count/5b3b4cc28fa96d39870443e3', res => {
