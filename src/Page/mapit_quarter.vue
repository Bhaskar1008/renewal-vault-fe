<template>
    ...
    <v-card>
     <v-layout row wrap >
        ...
        <v-flex class="ml-3 mr-3 mt-2 ma-5" style="flex-flow:column wrap; width:97%;">  
                        ...
                        <v-stepper-content step="1">
                            ...
                            <v-layout row  class="yesrow" >
                                    ...
                                    <v-flex class="mt-2 mb-2" style="width: 207px !important;" >
                                            <v-select v-model="quaterly_map_channel" 
                                                    :items="channeldataall"  
                                                    return-object
                                                     item-text="text" 
                                                    item-value="value" 
                                                    label="Select Channel *"
                                                    @change="channelfilters(quaterly_map_channel)" >
                                            </v-select>               
                                    </v-flex>
                                    <div   class="mt-2 mb-2" >
                                            <!-- <p>Select Year</p>  -->
                                    ...
                                    <div  class="mt-2 mb-2" >
                                            <!-- <p>Select Month</p>  -->
                                            <v-select v-model="monthitis" autocomplete :items="qurtercollection" item-text="text" return-object @change="setquarter(monthitis)" label="Select Quarter *"></v-select>
                                    </div>
                                    <div  class="mt-2 mb-2" >
                                        <v-btn @click="tfu" > Upload Sheet </v-btn>
                                        <input style="display:none;"  ref="fileref" type="file" id="fileUpload" @change="jsonupload">
                                    </div>
                                    <div  class="mt-2 mb-2" style="display:flex; flex-direction: row; align-items: center;">
                            ...
                            <v-btn text @click="clearall" >Cancel</v-btn>
                        </v-stepper-content>
            ...
            <v-dialog  
                v-model="savemapstate" width="450"
            >
            <v-card   class="pa-3">
            ...
            <v-dialog  
                ...
                <v-card   class="pa-3">
                        ...
                        <v-layout row justify-center > 
                            ...
                            <v-btn @click="clr_channel" >No</v-btn>
                        </v-layout>
...
export default {
    ...
    created(){
        ...
        loadChannel.getChannel(this, res => {
                ...
                this.$store.commit('SET_PAGE_TITLE','Map Quarter KPI');
            ...
            console.log("if qmapp has data ->", this.$store.state.qmappingdata );         
            if(this.$store.state.qmappingdata.q_maindata.length != 0){
                // ss99
                console.log("qmapping data from IF was not found empty ->", this.$store.state.qmappingdata);
    ...
    methods:{
        ...
        clear_map_state(){
            ...
            this.stop_previous = false
               ...
               var pass_empty = {
                ...
                this.$store.commit('SQMD', pass_empty );

                // console.log("SQMD ->", this.$store.state.qmappingdata );
        ...
        restoremapstatenow(){
              ...
              this.savemapstate = false
              this.e1 = 2;
              this.allbulkdata = this.$store.state.qmappingdata.sheet_data;
              this.first_col_values = this.$store.state.qmappingdata.q_maindata;
              this.quaterly_map_channel.value = this.$store.state.qmappingdata.q_channel;
              this.yearitis = this.$store.state.qmappingdata.qyear;
              this.monthitis = this.$store.state.qmappingdata.qmonth;
              this.display_ch = this.$store.state.qmappingdata.m_ch_name;
              var compstore = this.$store.state.qmappingdata.q_maindata.length;
              var compfirstcol = this.first_col_values.length;
              this.just_columns = this.$store.state.qmappingdata.q_cols
               console.log("Restored Mappings r ->", this.first_col_values);
        ...
        resetstore(){
            this.$store.state.qmappingdata = [];
            console.log("reset working ? =>",   this.$store.state.qmappingdata );
        },
       ...
       savestate(){
        ...
        if(this.final_apihit){
                ...
                var formatching = [];
                    ...
                    if(this.saveit_as_not_empty){
                        ...
                        var final_store = {
                                 qyear: this.yearitis ,
                                 qmonth:  this.monthitis,
                                 ch_name: this.display_ch,
                                 q_channel: this.quaterly_map_channel.value,
                                 q_cols: this.just_columns,
                                 q_maindata: save_q_map,
                                 sheet_data: this.allbulkdata
                        }
                        this.$store.commit('SQMD', final_store );
                        console.log('Saving to store as some values were selected')
                        console.log("stored SQMD state is ->", this.$store.state.qmappingdata)
                    }else{
        ...
        nextitis(){
                ...
                if(Object.keys(this.quaterly_map_channel).length == 0 || this.yearitis == '' || this.monthitis == ''){
        ...
        fetch_previous_mapping(){
            ...
            this.GET('fetchKPIMaster/quater_mapping?userId='+this.getAgentInfo()._id+'&channel='+this.quaterly_map_channel.value, (res, error ) => {     
                if(error){
                ...
                console.log('@@@Previous mappings in p_maps =>', this.p_maps);
            ...
            console.log("first_col_values ->", this.first_col_values.length)
             ...
             for(let i=0; i<this.first_col_values.length ; i++){
                ...
                this.p_maps.filter(e => {
                    ...
                    if(e.maincatid ==  this.first_col_values[i].maincat.value && e.subcatid == this.first_col_values[i].main_sub_cat.value){
                        ...
                        console.log("unmatcehd data =>",   this.first_col_values[i].maincat.text)
                    }
             ...
             console.log('fcv after mapped headers =>', this.first_col_values);
            ...
            // console.log("main sub cat ->",themain_cat );
                    // this.mainobjis = {
                    //         err: false,
                    //         column: this.p_maps[i].sheetColumn ,
                    //         maincat:{
                    //             text: this.p_maps[i].mainCategory,
                    //             value: this.p_maps[i].maincatid,
                    //             visib: false,
                    //         },
                    //         // subcat_filter:[],
                    //         main_sub_cat: {
                    //             text: this.p_maps[i].mappedWithSubCategory,
                    //             value:  this.p_maps[i].subcatid,
                    //             visib:false,
                    //         }        
                    // }
            ...
            for(let i=0; i<jc.length; i++){
                ...
                this.p_maps.filter(e=>{
                    ...
                    if(e.sheetColumn == jc[i]){
                        console.log("matched", e.sheetColumn)
                        var pos =  jc.indexOf(e.sheetColumn)
                        console.log("pos is ->", pos);
                        this.just_columns.splice(pos, 1);   
                    }else{
                ...
                console.log("MAIN JUST_COLUMNS ->", this.just_columns);

                var a3 = [];                                                            
                var a4 = [];
                a3 =  this.just_columns;
                a4 = pmapscolumns
                // a3.push("NEW GPW")
                a3 = a3.concat().sort();
                a4 = a4.concat().sort();
                ...
                console.log("is same from for loop ->", is_same);
        ...
        setquarter(data){
                this.monthitis = data.value;
                console.log("quarter it is ->", this.monthitis);
        },
        ...
        getting_main_cat(channel){
            ...
            this.GET('fetchKPIMaster/main_category?userId='+this.getAgentInfo()._id+'&channel='+channel, (res, error) => {
                ...
                if(res.data.errCode == -1){
                     this.redirect_enable = false;
                    console.log("main cat data", res.data.errMsg[0])
                    ...
                    console.log("reached 303 errocode else if block")
        ...
        filtercols(e, index){
             ...
             console.log("the selected one s ");
        ...
        savemapping(){
            ...
            this.POST('KPIMasters/quater_mapping' , { mapping:this.finalmapping, channel: this.quaterly_map_channel.value , userId: this.getAgentInfo()._id  } ,res => {
                if(res.data.errCode == -1){
            ...
            const formData = {
                userId:this.getAgentInfo()._id,
                qauter_kpiJSON: this.allbulkdata,
                quater_id: this.monthitis,
                year: this.yearitis,
                channel: this.quaterly_map_channel.value
            };
            ...
            // console.log("FormData before sending is", formData);
                    ...
                    let self = this;
                    this.POST('v2/QuaterlyKpi', formData, (res, err) => {
                            ...
                            if (res.data.errCode == -1){
                                ...
                                setTimeout(function(){  
                                    self.showLoader('Uploading', false);
                                    self.showToast("Mapping Data & Quarterly KPI Sheet successfully uploaded", "success", );
                                    // self.showToast("Quarterly KPI Sheet has been successfully uploaded", "success", ); 
        ...
        //    alert("from all process");
            ...
            // // console.log("Final JSON Result:::::::",Str);
            // //  let StrParse = JSON.parse(Str)
            // this.allbulkdata = Str
            // console.log("BULK >>>>>>>>>>>>>> JSON is ->", Object.keys(result[0]));
            this.$refs.fileref.value = '';
              var workbook = XLSX.read( data , {type: 'array'});
                    ...
                    // console.log("sheet to json result is ", jsondata);
            if(jsondata.length == 0){
              ...
              var newdata  = jsondata;
                ...
                console.log("a3 sorted newdata is ->", a3);
                console.log("a4 sorted newdata is ->", a4);
                ...
                if(is_same){
                    ...
                    console.log("An error has occured, fallback will ensure you have relevant values of headers to map instead of empty values");
                        ...
                        for (var i = 0; i < Object.keys(cells).length; i++){
                            ...
                            console.log("INDEX OF 1 is ->", cells[i].indexOf('1'));
...
//         }   
//         console.log("Cells for h in just_columns is  ->",this.just_columns );
        ...
        // ds99
         ...
         for(let i=0; i< this.def_set.length; i++){
             ...
             console.log("Length of first col is->",  this.first_col_values.length);
        ...
        Searchdatatable (e) {
            ...
            channelfilters(e){
                console.log('data',e)
                this.page=1
                this.channeldatafilter = e.value
                this.display_ch = e.text
