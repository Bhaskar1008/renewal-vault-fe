        ...
        <!-- <v-content> -->
            ...
            <v-layout row wrap >
                <v-flex class="ml-3 mt-3" style="flex-flow:column wrap">
                    <!-- <v-text class="headline font-weight-bold">About Us</v-text> -->
                    <!-- <hr> -->
                    <v-flex xs12 sm6 md6 ml-3 mt-3>
                        <v-flex xs12 sm6 md6 mt-3>
                            <v-text class="title font-weight-bold">About-Us Title:</v-text>  
                        </v-flex>
                        <v-text-field placeholder="Title" v-model="storyTitle"></v-text-field>
                    </v-flex>
                    <v-flex xs12 sm6 md6 ml-3 mt-3>
                      <v-flex xs12 sm6 md6 mt-3>
                          <v-text class="title font-weight-bold">About Us-Description:</v-text>  
                      </v-flex>
                    </v-flex>
...
<script>
    ...
    export default {
        ...
        created(){
        this.$store.commit('SET_PAGE_TITLE','About us');
