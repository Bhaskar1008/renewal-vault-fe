...
export default {
    ...
    dis(){
        ...
        fetchAll() {
            ...
            const FETCH_TESTIMONIALS =  this.API_Service_admin()+'fetch_sales_pitch?type=presentation&filter=0';
            axios
        ...
        uploadFile(sendFile) {
            ...
            const UPLOAD_API = 'http://159.89.161.64:5035/secure/admin/uploadFile'
        ...
        save() {
            ...
            if (this.formFields.title == null || this.formFields.title == undefined || this.formFields.title == "" || this.channeldatafilter === "") {
