...
export default{
    ...
    created() {
        ...
        this.$store.commit('SET_PAGE_TITLE', 'Recruitment Activity Tracker');
        let val ='';
        let self = this;
    ...
    methods: {
       ...
       channelfilters(e) {
        ...
        DownloadUserReport(empcode){
            ...
            let API = 'getrackerData/'+this.getAgentInfo()._id+'?filter=Recruitment Activity Tracker&employeeCode='+empcode+'&reportType=xls&fromDate='+fromdate+'&toDate='+todate+'&channelCode='+this.channeldatafilter
            this.GET(API,res=>{
